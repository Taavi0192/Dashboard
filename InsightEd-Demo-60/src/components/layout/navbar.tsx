        ...
        <div className="hidden md:block">
          ...
          >
            <ul className="flex flex-col items-center space-y-4 opacity-60 md:flex-row md:space-x-6 md:space-y-0">
              {navLinks.data.map((item: { href: string | UrlObject; disabled: any; title: string | number | bigint | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<AwaitedReactNode> | null | undefined }, index: Key | null | undefined) => {
                return (
                  item.href && (
                    <Link
                      key={index}
