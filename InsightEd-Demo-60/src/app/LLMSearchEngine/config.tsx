...
//     useOllamaInference: false,
//     useOllamaEmbeddings: false,
//     searchProvider: 'serper', // Or 'google' depending on your setup
//     inferenceModel: 'gpt-4', // Change to 'gpt-3.5-turbo' or 'gpt-4' for OpenAI
//     inferenceAPIKey: process.env.OPENAI_API_KEY, // Use OpenAI key
//     embeddingsModel: 'text-embedding-3-small', // Appropriate for OpenAI
//     textChunkSize: 800,
//     textChunkOverlap: 200,
//     numberOfSimilarityResults: 4,
//     numberOfPagesToScan: 10,
//     nonOllamaBaseURL: 'https://api.openai.com/v1', // Use OpenAI’s API base URL
